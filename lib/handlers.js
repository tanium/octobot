...
exports.commitCommentHandler = function(slack) {
    return function(data) {
        if (data.action == 'created' || data.action == 'edited') {
            ...
            messages.sendToAll(slack, msg, attachments, data.comment, data.repository);
        }
        return 200;
    }
}
...
exports.pullRequestHandler = function(slack) {
    return function(data) {
        ...
        if (verb) {
            ...
            messages.sendToAll(slack, msg, attachments, data.pull_request, data.repository);
        }
...
exports.issueCommentHandler = function(slack) {
    return function(data) {
        ...
        if (data.action == "created" || data.action == "edited") {
            ...
            messages.sendToAll(slack, msg, attachments, data.issue, data.repository);
        }
...
exports.statusHandler = function(slack) {
    return function(data) {
        ...
        messages.sendToAll(slack, msg, attachments, data.commit, data.repository);
