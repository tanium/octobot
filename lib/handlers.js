...
exports.pingHandler = function(slack) {
    return function(data) {
        return 200;
    }
}

exports.commitCommentHandler = function(slack) {
    return function(data) {
        if (data.action == 'created' || data.action == 'edited') {
            ...
            messages.sendToAll(slack, msg, attachments, data.comment, data.repository, data.sender);
        }
        return 200;
    }
}

exports.pullRequestHandler = function(slack) {
    return function(data) {
        var verb;
        var extra = '';
        ...
        if (verb) {
            ...
            messages.sendToAll(slack, msg, attachments, data.pull_request, data.repository, data.sender);
        }
...
exports.pullRequestCommentHandler = function(slack) {
    return function(data) {
        if (data.action == "created" || data.action == "edited") {
...
exports.pullRequestReviewHandler = function(slack) {
    return function(data) {
        if (data.action == "submitted") {
            var stateMsg, actionMsg, color;
            if (data.review.state === "changes_requested") {
                actionMsg = "requested changes on" ;
...
exports.issueCommentHandler = function(slack) {
    return function(data) {
        ...
        if (data.action == "created" || data.action == "edited") {
            ...
            messages.sendToAll(slack, msg, attachments, data.issue, data.repository, data.sender);
        }
...
exports.statusHandler = function(slack) {
    return function(data) {
        ...
        messages.sendToAll(slack, msg, attachments, data.commit, data.repository, data.sender);
